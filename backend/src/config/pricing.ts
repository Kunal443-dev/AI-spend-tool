export interface PricingPlan {
  ...
  metadata?: {
    ...
    isApi?: boolean;
    hasIndividualEquivalent?: string;
  };
}
...
export const PRICING_CATALOG: Record<string, ToolPricing> = {
  chatgpt: {
    toolName: "ChatGPT",
    toolId: "chatgpt",
    plans: [
...
export const getPlanDetails = (toolId: string, planId: string): PricingPlan | null => {
